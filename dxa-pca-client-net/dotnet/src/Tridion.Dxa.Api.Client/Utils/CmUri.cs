...
namespace Tridion.Dxa.Api.Client.Utils
{
    ...
    public class CmUri
    {
        ...
        public CmUri(ContentNamespace uriNamespace, int publicationId, int itemId, Tridion.Dxa.Api.Client.ItemType? itemType, int? version)
        {
        ...
        public CmUri(ContentNamespace uriNamespace, int publicationId, int itemId, Tridion.Dxa.Api.Client.ItemType? itemType)
        {
            Namespace = uriNamespace;
            PublicationId = publicationId;
            ItemId = itemId;
        ...
        public static CmUri Create(ContentNamespace namespaceId, int publicationId, int itemId, Tridion.Dxa.Api.Client.ItemType itemType, int version) 
        ...
        public static bool TryParse(string uri, out CmUri cmUri)
        {
            ...
            try
            {
                ...
                {
                    itemType = Tridion.Dxa.Api.Client.ItemType.Component;
                }
