...
namespace Sdl.Web.Tridion.ModelService
{
    public class DefaultModelServiceProvider : IModelServiceProvider
    {
        ...
        private readonly IOptions<DxaFrameworkOptions> _dxaFrameworkOptions;
        private readonly Binder _binder;
        private const int DefaultDescendantDepth = 10;
        private readonly int _descendantDepth;

        public DefaultModelServiceProvider(IApiClientFactory apiClientFactory, IOptions<DxaFrameworkOptions> dxaFrameworkOptions)
        {
            _apiClientFactory = apiClientFactory;
            _dxaFrameworkOptions = dxaFrameworkOptions;
            _binder = new Binder();


            _descendantDepth = int.TryParse(
                _dxaFrameworkOptions.Value.SitemapDefaultDescendantDepth, out _descendantDepth)
                ? _descendantDepth
                : DefaultDescendantDepth;

            //_descendantDepth = DefaultDescendantDepth;
        }
        ...
        protected global::Tridion.Dxa.Api.Client.ApiClient Client
        {
            get
            {
