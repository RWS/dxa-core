...
namespace Sdl.Web.Tridion.Providers.ModelService
{
    ...
    {
        internal static ISitemapItem GetEntireTree(global::Tridion.Dxa.Api.Client.ApiClient client, ContentNamespace ns, int pubId, int requestLevels)
        {
        ...
        internal static List<ISitemapItem> GetEntireTree(global::Tridion.Dxa.Api.Client.ApiClient client, ContentNamespace ns, int pubId, string parentSitemapId, bool includeAncestors, int requestLevels)
        {
