        ...
        static ModelBuilderPipeline()
        {
            ...
            using (new Tracer())
            {
                ...
                try
                {
                    ...
                    if (_dxaFrameworkOptions.ModelBuilderPipelineConfig == null)
                    {

                        Log.Warn($"No 'ModelBuilderPipelineConfiguration' configuration section found.");
                    ...
                    else
                    {
                        ...
                        foreach (var builderType in _dxaFrameworkOptions.ModelBuilderPipelineConfig)
                        {


                            Type modelBuilderType = Type.GetType(builderType.Type, throwOnError: true, ignoreCase: true);
