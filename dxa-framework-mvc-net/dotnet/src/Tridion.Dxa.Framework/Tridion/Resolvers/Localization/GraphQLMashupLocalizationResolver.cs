...
namespace Sdl.Web.Tridion
{
    ...
    /// </summary>
    public class GraphQLMashupLocalizationResolver : DefaultLocalizationResolver
    {
        ...
        public GraphQLMashupLocalizationResolver(IApiClientFactory apiClientFactory) : base(apiClientFactory)
        {
