...
namespace Sdl.Web.Mvc.Html
{
    ...
    public static class UrlHelperExtensions
    {
        ...
        public static string ResponsiveImage(this IUrlHelper urlHelper, string sourceImageUrl, double aspect, string widthFactor, int containerSize = 0)
        {
        ...
        public static string NormalizePageUrlPath(this IUrlHelper urlHelper, string urlPath)
        {
