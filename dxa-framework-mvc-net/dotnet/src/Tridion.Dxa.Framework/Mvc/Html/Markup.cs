...
namespace Sdl.Web.Mvc.Html
{
    ...
    public static class Markup
    {
        ...
        internal static HtmlString DecorateMarkup(HtmlString htmlToDecorate, ViewModel viewModel)
        {
        ...
        internal static HtmlString RenderEntityAttributes(EntityModel entityModel)
        {
        ...
        /// <returns>The semantic markup (HTML/RDFa attributes).</returns>
        internal static HtmlString RenderPropertyAttributes(EntityModel entityModel, string propertyName, int index = 0)
        {
        ...
        /// <param name="index">The index of the property value (for multi-value properties).</param>
        /// <returns>The semantic markup (HTML/RDFa attributes).</returns>
        internal static HtmlString RenderPropertyAttributes(EntityModel entityModel, MemberInfo propertyInfo, int index = 0)
        {
            string markup = string.Empty;
        ...
        /// <returns>The semantic markup (HTML/RDFa attributes).</returns>
        internal static HtmlString RenderRegionAttributes(RegionModel regionModel)
        {
        ...
        private static string RenderXpmMarkupAttribute(ViewModel viewModel, string propertyName = null, int index = 0)
        {
            ...
            if (propertyName == null)
            {
                ...
                xpmMarkup = viewModel.GetXpmMarkup(WebRequestContext.Current.Localization);
