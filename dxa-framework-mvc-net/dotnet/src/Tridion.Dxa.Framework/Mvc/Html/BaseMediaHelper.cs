    ...
    public class BaseMediaHelper : IMediaHelper
    {
        ...
        public virtual int GetResponsiveWidth(string widthFactor, int containerSize = 0)
        {
            ...
            if (!widthFactor.EndsWith("%"))
            {
                ...
                {
                    width = width * WebRequestContext.Current.ContextEngine.GetClaims<DeviceClaims>().PixelRatio;
                }
            }
            ...
            if (widthFactor.EndsWith("%"))
            {
                ...
                switch (WebRequestContext.Current.ScreenWidth)
                {
                ...
                width = WebRequestContext.Current.MaxMediaWidth;
