...
namespace Sdl.Web.Mvc.Controllers
{
    public class EntityController : BaseController
    {
        ...
        //  [DxaNoOutputCache]
        public virtual ActionResult Entity([ModelBinder(typeof(DxaModelBinder))] EntityModel entity, int containerSize = 0)
        {
            ...
            if (model is RedirectModel)
            {
                ...
                Response.Redirect(((RedirectModel)model).RedirectUrl);
                return null;
            }
        ...
        protected bool MapRequestFormData(EntityModel model)
        {
            ...
            foreach (string formField in Request.Form.Keys)
            {
